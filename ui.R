...
require("gplots");require("kohonen");require("devtools");
...
require('shinythemes');require('shinyBS');require('FactoMineR')


shinyUI(navbarPage(title="rTLC V.Re99.0",theme = shinytheme("yeti"),
                   tabPanel("Data input",
                            ...
                            fluidRow(
                              column(width=3,
                               ...
                               hr(),
                               textInput('checkpoint.1.download.text','Filename','Checkpoint_1'),
                               downloadButton("checkpoint.1.download",'Save Chromatograms'),
                               tags$hr(),
                               textInput('checkpoint.1.download.zip.text','Filename','Zip_export'),
...
#                                              ),
                              ...
                              tabPanel("LDA",  ####### LDA ####### -> change to LDA
                                       sidebarLayout(
                                         sidebarPanel(
                                           h4("LDA"),
                                           helpText(   a("Help with this feature",target="_blank",
                                                         href="https://stat.ethz.ch/R-manual/R-devel/library/MASS/html/lda.html")
                                           ),
                                           tags$hr(),
                                           h4("Variable of interest"),
